...
pub fn parse_satrec(str1: &str, str2: &str) -> Satrec {
  ...
  let jdsatepoch = ext::jday(year as f64, jd.month, jd.day, jd.hour, jd.minute, jd.second, 0.0);
